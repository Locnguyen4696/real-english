...
const FooterHeading = ({ children, withLogo }: IFooterProps) => {
    return (
        <StyledFlex justifyContent="space-between" alignItems="center">
            {withLogo && <Image src={Logo} alt="logo" width={64} height={64} />}
        ...
        <Wrapper>
            <Column gap="24px" flexDirection="column">
                ...
                <Text color={colors.regular}>
                    The Real IELTS - Hệ thống luyện thi IELTS hàng đầu cho thanh
                    thiếu niên Việt Nam.
                </Text>
                <Text color={colors.regular}>
                    Tại The Real IELTS, với phương châm Học thật - Thi thật -
                    Điểm thật, chúng tôi cam kết sát cánh cùng học viên tới khi
                    đạt được mục tiêu trình độ và điểm số đã đề ra.
                </Text>
            </Column>
            <Column gap="24px" flexDirection="column">
            ...
            <Column gap="24px" flexDirection="column">
                ...
                <Text color={colors.regular}>
                    Tầng 2, Tòa Servin Office, Nam Đô Complex, 609 Trương Định,
                    Hoàng Mai, Hà Nội
                </Text>
                <Text color={colors.regular}>
