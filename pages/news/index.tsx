...
const News: NextPage = () => {
  return (
    <>
      ...
      >
        ...
        <Flex gap="30px">
          <Nav flexDirection="column" gap="16px">
            <NavItem className="active">Tin hot tuần này</NavItem>
            <NavItem>Chương trình khuyến mãi</NavItem>
            <NavItem>Hoạt động nội bộ</NavItem>
          </Nav>
      ...
      >
        <Text bold fontSize="24px" lineHeight="32px" color="white">
          Đăng ký
        </Text>
      </Button>
    </>
